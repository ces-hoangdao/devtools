          ...
          <div className="grid items-center grid-cols-1 md:grid-cols-2">
            <div>
              ...
              <p className="max-w-lg mt-3 text-xl leading-relaxed text-gray-600 md:mt-8">
                ...
                <br />I am building a product that
                can solve developer&lsquo;s pain.
                It is has to much tool we need to
                bookmark. Now we have Tools4dev
                where have all tools helpful
                developer need.
              </p>
